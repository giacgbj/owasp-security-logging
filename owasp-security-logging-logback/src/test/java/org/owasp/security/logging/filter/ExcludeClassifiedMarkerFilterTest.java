...
public class ExcludeClassifiedMarkerFilterTest {
    ...
    public void testAppenderSecurityEvent() {
        LOGGER.info(SecurityMarkers.SECURITY_SUCCESS, "This statement is a security event");
    ...
    public void testAppenderMultipleEvent() {
        ...
        LOGGER.info(multi, "This statement contains multiple markers: audit and confidential");
