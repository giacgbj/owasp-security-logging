 ...
 * 
 * The default behavior of this filter is to deny all non-security events and pass security events to the rest of the filter chain. If acceptAll is true, then all security related events will pass
 * this filter, regardless of other filters on the filter chain. To enable acceptAll, configure the filter as follows:
 * 
 * <pre>
 * {@code
