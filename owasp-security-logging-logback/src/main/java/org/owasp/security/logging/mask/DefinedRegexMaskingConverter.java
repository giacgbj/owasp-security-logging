...
/**
 * Masking configured values in logs. To configure in you logback file here is an example: Step 1 add conversion word:
 * 
 ...
 * 
 * %maskedMsg{password|signature username, orderNumber|giftCardNum|, email }
 * 
