...
/**
 * The DefaultIntervalLoggerView formats the key/value pairs for logging using the following format, <code>
 * Watchdog: property1=value1, property2=value3, ...
 * </code> All values are logged on a single line.
 * 
 * @author Milton Smith
 *
 */
