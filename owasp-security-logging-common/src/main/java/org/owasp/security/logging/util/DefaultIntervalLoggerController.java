...
/**
 * Default implementation of the DefaultIntervalLoggerController. The controller orcastrates the workflow for logging status. To obtain an instance of the controller and start logging status do the
 * following, <code>
...
class DefaultIntervalLoggerController implements IntervalLoggerController, Runnable {
     ...
     * 
     * @param interval
     *            User specified interval in milliseconds to log each status message.
     ...
     * 
     * @param IntervalLoggerView
     *            instance to use. DefaultIntervalLoggerView is assigned by default.
     * @see org.owasp.security.logging.util.IntervalLoggerController
     ...
     * 
     * @param IntervalLoggerModel
     *            instance to use. DefaultIntervalLoggerModel is assigned by default.
     * @see org.owasp.security.logging.util.IntervalLoggerController
    ...
    /**
     * This event is fired each elapsed interval. The default controller retrives the properties, refreshes the model(and properties), formats the status for logging, and finally logs the message.
     */
