...
public class SecurityUtil {
    ...
    /**
     * Redirect <code>System.out</code> and <code>System.err</code> streams to SLF4J logger. This is a benefit if you have a legacy console logger application. Does not provide benefit of a full
     * implementation. For example, no hierarchical or logger inheritence support but there are some ancilarity benefits like, 1) capturing messages that would otherwise be lost, 2) redirecting
     * console messages to centralized log services, 3) formatting console messages in other types of output (e.g., HTML).
     */
    ...
    /**
     * Redirect <code>System.out</code> and <code>System.err</code> streams to the given SLF4J loggers. This is a benefit if you have a legacy console logger application. Does not provide benefit of a
     * full implementation. For example, no hierarchical or logger inheritence support but there are some ancilarity benefits like, 1) capturing messages that would otherwise be lost, 2) redirecting
     * console messages to centralized log services, 3) formatting console messages in other types of output (e.g., HTML).
     * 
     * @param sysOutLogger
     * @param sysErrLogger
    ...
    /**
     * Log the formatted message at the INFO priority. Override this method to log your status using security markers or different log levels like the following, <code>
     * tbd
     * </code>
     * 
     * @param message
