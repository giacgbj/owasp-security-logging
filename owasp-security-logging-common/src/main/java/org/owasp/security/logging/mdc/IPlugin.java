...
/**
 * This interface defines a plugin to the MDC filter. Applications can implement this interface to add functionality to the MDCFilter. For example, an implementing class might provide custom behavior
 * for determining an authenticated username.
 * 
